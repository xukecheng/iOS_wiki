...
r = requests.get("https://developer.apple.com/tutorials/data/index/swiftui")
print(r.status_code)

json_data = json.loads(r.text)
print(json_data)

swiftUI = json_data["interfaceLanguages"]["swift"][0]["children"]
...
for key, value in urls.items():
    try:
        with open(
            f"Documentation/swiftUI/Documentation/{key}.md",
            "r",
            encoding="utf-8",
        ) as f:
            continue
